...
if "${IS_CONTAINER:-false}"; then
  echo 'export STARSHIP_CONFIG="$DOT_DIR/files/.config/starship/remote_starship.toml"' > $DOT_DIR/files/.config/zsh/.zshenv.local
else
  echo 'export STARSHIP_CONFIG="$DOT_DIR/files/.config/starship/host_starship.toml"' > $DOT_DIR/files/.config/zsh/.zshenv.local
fi
